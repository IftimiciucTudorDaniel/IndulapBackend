...
using InDulap.Web.Component.Depurtat;
using InDulap.Web.Component.FashionDays;
using InDulap.Web.Component.OtterDays;
using InDulap.Web.Component.Sosetaria;

namespace InDulap.Web.Component
{
